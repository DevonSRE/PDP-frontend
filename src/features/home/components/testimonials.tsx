...
export function Testimonials() {
  ...
  return (
    <section className="h-full bg-[#F5F5F5] py-20 md:py-40 px-7 md:px-10">
      <div className="mx-auto max-w-6xl pb-8 flex flex-col gap-5 md:gap-1">
        ...
        <div className="flex flex-col gap-6 md:gap-12 w-full items-end">
