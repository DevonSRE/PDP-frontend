...
export function MeetTheProfessional() {
  return (
    <section className="relative w-full overflow-hidden py-20 md:py-62 px-7 md:px-10 bg-black">
      <>
        <PdpLogoBg className="hidden md:absolute absolute -top-40 -left-76 w-150" />
        <PdpLogoBg className="hidden md:absolute absolute -bottom-36 -left-78 w-150 rotate-184 -scale-x-100" />

        <PdpLogoBg className="hidden md:absolute absolute -bottom-20 -right-110 w-150 rotate-180" />
        <PdpLogoBg className="hidden md:absolute absolute -top-96 -right-42 w-150 rotate-98" />
      </>

      <div className="w-full md:container mx-auto  relative z-10 justify-center-safe space-y-16">
