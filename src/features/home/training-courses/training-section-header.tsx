...
export function TrainingSectionHeader() {
  return (
    <section className="relative overflow-hidden h-dvh w-full bg-white px-7 md:px-10 flex justify-center items-center">
      ...
      <>
        <SpikyCicle className="hidden md:block absolute -bottom-60 -right-60 w-220 text-brand-blue/50" />
        <SpikyCicle className="hidden md:block absolute -bottom-60 -right-60 w-200 text-brand-blue" />

        <SpikyCicle className="hidden md:block absolute -bottom-64 right-106 w-165 text-brand-blue/50" />
        <SpikyCicle className="hidden md:block absolute -bottom-64 right-114 w-150 text-brand-blue" />
      </>

      <div className="-translate-y-8 md:-translate-y-14 relative overflow-hidden">
        {/* Content */}
        <div className="relative max-w-full md:max-w-7xl w-full mx-auto z-10 flex flex-col gap-6 md:gap-12">
          <div className="text-center flex flex-col gap-4">
            ...
            <p className="text-sm md:text-base max-w-full md:max-w-xl w-full mx-auto font-light">
